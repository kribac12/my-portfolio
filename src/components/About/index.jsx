...
function About() {
  return (
    <section id="about" className="px-4 py-10 mt-4 bg-lightColor text-black">
      <div className="flex flex-col md:flex-row max-w-6xl mx-auto items-center">
        ...
        <div>
          <h2 className="uppercase text-4xl font-light mb-6">About Me</h2>
          ...
          <p className="text-lg mb-4">
            ...
            profession. Now, in the tech world, I channel these traits into coding, constantly exploring new technologies and techniques to push the limits of
            what I can create.
          </p>
